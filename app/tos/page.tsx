...
export default function TermsOfServicePage() {
  return (
    <LegalPageLayout title="TERMS OF USE" lastUpdated="July 17, 2026">
      <section>
        ...
        <div className="space-y-3 text-[15px]">
          <p>
            We are <strong>LUMARO NEXUS</strong> (&quot;Company,&quot; &quot;we,&quot;
            &quot;us,&quot; &quot;our&quot;).
          </p>
          <p>
          ...
          <p>
            ...
            or by mail to NYAMIRAMBO, Kigali, Kigali City, Rwanda.
          </p>
          <p>
            ...
            <strong>LUMARO NEXUS</strong>, concerning your access to and use of the
          ...
          <p>
            ...
            notifying you by info@lumaronexus.com, as stated in the email message. By
      ...
      <section id="services">
        <h2 className="text-xl font-bold text-gray-900 mb-3">1. OUR SERVICES</h2>
        <div className="space-y-3 text-[15px]">
          <p>
      ...
      <section id="ip">
        ...
        <div className="space-y-3 text-[15px]">
          ...
          <p>
            ...
            of (a) this section, (b) any third party&apos;s intellectual property rights,
            or (c) applicable law.
          </p>
        </div>
      </section>
      ...
      <section id="prohibited">
        <h2 className="text-xl font-bold text-gray-900 mb-3">4. PROHIBITED ACTIVITIES</h2>
        <div className="space-y-3 text-[15px]">
          <p>
      ...
      <section id="ugc">
        ...
        <div className="space-y-3 text-[15px]">
          ...
          <p>
            (as applicable under these Legal Terms and the{' '}
            <a href="#prohibited" className={linkClass}>
              PROHIBITED ACTIVITIES
            </a>{' '}
            section) you have the right to submit such Contributions and that doing so does
      ...
      <section id="license">
        <h2 className="text-xl font-bold text-gray-900 mb-3">6. CONTRIBUTION LICENSE</h2>
        <div className="space-y-3 text-[15px]">
          <p>
      ...
      <section id="management">
        <h2 className="text-xl font-bold text-gray-900 mb-3">7. SERVICES MANAGEMENT</h2>
        <div className="space-y-3 text-[15px]">
          <p>
      ...
      <section id="term">
        <h2 className="text-xl font-bold text-gray-900 mb-3">8. TERM AND TERMINATION</h2>
        <div className="space-y-3 text-[15px]">
          <p>
      ...
      <section id="law">
        ...
        <div className="space-y-3 text-[15px]">
          <p>
            ...
            <strong>Rwanda</strong>. <strong>LUMARO NEXUS</strong> and yourself irrevocably
            consent that the courts of <strong>Kigali, Rwanda</strong> shall have exclusive
      ...
      <section id="disputes">
        ...
        <div className="space-y-3 text-[15px]">
          <h3 className="text-lg font-semibold text-gray-900">Informal Negotiations</h3>
          <p>
            ...
            <strong>thirty (30)</strong> days before initiating arbitration. Such informal
            negotiations commence upon written notice from one Party to the other Party.
          </p>
          <h3 className="text-lg font-semibold text-gray-900">Binding Arbitration</h3>
          <p>
            ...
            United Nations Commission on International Trade Law Arbitration Rules in force
            at the time of commencement of the arbitration. The number of arbitrators shall
            be <strong>one (1)</strong>. The seat, or legal place, of arbitration shall be{' '}
            <strong>Kigali, Rwanda</strong>. The language of the proceedings shall be{' '}
            <strong>English</strong>. The governing law of these Legal Terms shall be the
            substantive law of <strong>Rwanda</strong>.
          </p>
      ...
      <section id="corrections">
        <h2 className="text-xl font-bold text-gray-900 mb-3">12. CORRECTIONS</h2>
        <div className="space-y-3 text-[15px]">
          <p>
      ...
      <section id="disclaimer">
        <h2 className="text-xl font-bold text-gray-900 mb-3">13. DISCLAIMER</h2>
        <div className="space-y-3 text-[15px]">
      ...
      <section id="liability">
        ...
        <div className="space-y-3 text-[15px]">
          <p className="uppercase text-sm leading-relaxed">
            ...
            LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR{' '}
            <strong>USD 100</strong>. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT
      ...
      <section id="indemnification">
        <h2 className="text-xl font-bold text-gray-900 mb-3">15. INDEMNIFICATION</h2>
        <div className="space-y-3 text-[15px]">
          <p>
            ...
            Terms; (3) any breach of your representations and warranties set forth in these
            Legal Terms; (4) your violation of the rights of a third party, including but
      ...
      <section id="userdata">
        <h2 className="text-xl font-bold text-gray-900 mb-3">16. USER DATA</h2>
        <div className="space-y-3 text-[15px]">
          <p>
      ...
      <section id="contact">
        ...
        <div className="space-y-3 text-[15px]">
          ...
          <p>
            ...
            <br />
            Support:{' '}
            <a href="mailto:help@lumaronexus.com" className={linkClass}>
